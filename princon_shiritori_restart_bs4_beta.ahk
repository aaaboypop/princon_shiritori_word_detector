...
loop
{
    ...
    loop {
        ImageSearch, , , 891, 682, 917, 713, *24 %A_ScriptDir%\try.png
        If (ErrorLevel=0){
        ...
        ImageSearch, , , 574, 527, 600, 558, *24 %A_ScriptDir%\try2.png
        If (ErrorLevel=0){
            ClickNA(642+1,528+8) ; Restart
            ClickNA(642+1,528+8)
        }
        ImageSearch, , , 895, 368, 906, 402, *4 %A_ScriptDir%\findcha.png
        Sleep, 100
    }	
    Until (ErrorLevel=0)
    ...
    Else
    {
        ClickNA(1216+1,697+8) ; pause
        ClickNA(1216+1,697+8)
        Sleep, 500
        ClickNA(642+1,528+8) ; Restart
        ClickNA(642+1,528+8)
    }
